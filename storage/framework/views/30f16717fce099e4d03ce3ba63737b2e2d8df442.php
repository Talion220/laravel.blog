            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form role="form" method="post" action="<?php echo e(route('posts.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" id="description" rows="5" placeholder="Цитата ..."></textarea>
                                </div>
...
unset($__errorArgs, $__bag); ?>" id="content" rows="7" placeholder="Контент ..."></textarea>
                                </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\OpenServer\domains\laravel.blog\resources\views/admin/posts/create.blade.php ENDPATH**/ ?>